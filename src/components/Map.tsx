...
const Map = () => {
  ...
  return (
    <motion.section
      ...
      className='relative xl:after:w-full xl:aafter:h-[240px] xl:after:from-white  xl:after:via-white/80  xl:after:to-white/20  xl:after:absolute
         xl:after:top-0  xl:after:z-20   xl:after:bg-gradient-to-b' id='contact'>
      <MapContainer center={[34.052235, -118.243683]}
        zoom={isMobile ? 10 : 12}
